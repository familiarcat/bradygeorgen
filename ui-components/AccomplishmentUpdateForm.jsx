...
import { getAccomplishment } from "./graphql/queries";
...
export default function AccomplishmentUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = accomplishmentRecord
      ? { ...initialValues, ...accomplishmentRecord }
      : initialValues;
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getAccomplishment.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getAccomplishment
        : accomplishmentModelProp;
      setAccomplishmentRecord(record);
    };
    queryData();
  }, [idProp, accomplishmentModelProp]);
  React.useEffect(resetStateValues, [accomplishmentRecord]);
  const validations = {
    title: [],
    description: [],
    link: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateAccomplishment.replaceAll("__typename", ""),
            variables: {
              input: {
