...
export default function Home() {
  return (
    <ParallaxContainer>
      <ParallaxLayer speed={0.2} className="bg-gradient-to-br from-blue-900 to-purple-900" zIndex={0}><div className="absolute inset-0" /></ParallaxLayer>
        ...
        <div className="min-h-screen w-full">
          <div className="container mx-auto px-4 py-8 md:py-12">
            <BentoGrid className="gap-3 md:gap-4 lg:gap-6">
              ...
              <BentoItem colSpan={3} className="mt-0"><ContentSection /></BentoItem>
